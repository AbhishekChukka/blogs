...
function CreateBlog() {
    ...
    const [blogs, setBlogs] = useState({
        ...
        content: '',
        time: Timestamp.now(),
        userId: '' // This will be populated with the current user ID
    });
    ...
    const addPost = async () => {
        try {
            ...
            setBlogs({ ...blogs, userId: userID }); // Set user ID in the blogs state
    ...
    const uploadImage = () => {
        ...
        uploadBytes(imageRef, thumbnail).then((snapshot) => {
            getDownloadURL(snapshot.ref).then((url) => {
                ...
                try {
                    addDoc(productRef, {
                        ...blogs, // Include user ID in the blog post data
                        thumbnail: url,
                        time: Timestamp.now(),
        ...
        <div className=' container mx-auto max-w-5xl py-6'>
            <div className="p-5" style={{
                ...
                <Editor
                    ...
                    onInit={(evt, editor) => {
                        setBlogs({ ...blogs, content: editor.getContent({ format: 'text' }) });
                    }}
                    init={{
