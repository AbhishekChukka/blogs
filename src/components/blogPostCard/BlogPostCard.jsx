  ...
  return (
    <div>
      <section className="text-gray-900 body-font">
        <div className="container px-5 py-3 mx-auto max-w-7xl ">
                  ...
                  return (
                    <div className="p-4 md:w-1/3" key={index}>
                      <div
                        ...
                        className={`h-auto shadow-lg w hover:-translate-y-1 cursor-pointer hover:shadow-gray-400
                        ${mode === 'dark'
                            ? 'shadow-gray-700'
                            : 'shadow-xl'
                            } 
                      ...
                      >
                        {/* Blog Thumbnail  */}
                        <img onClick={() => navigate(`/bloginfo/${id}`)} className=" w-full h-62" src={thumbnail} alt="blog" />
